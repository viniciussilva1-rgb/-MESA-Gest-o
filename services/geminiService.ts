...
export const getFinancialInsights = async (stats: FinancialStats, recentTransactions: Transaction[]) => {
  try {
    ...
    const prompt = `
      ...
      - Reserva de Renda: € ${stats.fundBalances.ALUGUER.toFixed(2)} (Meta mensal de reserva estratégica: €1200 - equivalente a 3 meses de renda)
      ...
      Objetivo: Fornecer 3 conselhos estratégicos curtos focado na saúde ministerial, no alcance da meta de reserva de 1200€ e na transparência financeira.
